...
export class AiService {
  ...
  async *generateChatStream(
    ...
    // Deterministic, not random: confidence ramps with how many questions the
    // user has answered (more context = better model), and unresolved risk
    // shrinks accordingly. Random numbers here made the panel jump around
    // every turn, which reads as noise in a decision-intelligence product.
